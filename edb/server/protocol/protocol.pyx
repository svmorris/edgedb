...
cdef class HttpProtocol:
    ...
    def data_received(self, data):
        #cdef binary.EdgeConnection binproto
        ...
        if self.first_data_call:
            ...
            if ch0 not in {b'G', b'H', b'P', b'D', b'C', b'O', b'T', b'P'}:
                # This is, most likely, our binary protocol,
                # in compatibility mode.
                #
                # Switch protocols now.
    ...
    def on_message_complete(self):
        ...
        #self.port.last_minute_requests += 1 XXX
    ...
    async def handle_request(self, HttpRequest request, HttpResponse response):
        ...
        # url_path = request.url.path.strip(b'/').decode('ascii')
        1/0
